...
/* the processor the POST reports, as a stop of the table (processors.h),
 * the memory it counts, and 1 to read its clock as a fixed time */
void dos_init(int processor, int mem_mb, int fixed_clock);
