...
void housing_edge(canvas *c,float x,float y,float w,float h,float r, float ew,float shadow,int raised,float gain);
...
void rrect(canvas *c,float x,float y,float w,float h,float rad, int r,int g,int b,float shade_top,float shade_bot);
void seam(canvas *c,float x,float y,float len,int vertical,float w);
void soft_hedge(canvas *c,float x0,float x1,float y,float span, float mul_peak,float spec_peak,int downward);
