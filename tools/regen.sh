...
$PY tools/mklogo.py  assets/3dfx-sticker.png dxm_tdfx "$out/tdfx.h"
...
if [ "$mode" = "--check" ]; then
    rc=0
    for f in mark.h splash.c splash.h font16.h horizon.h tdfx.h banners.c banners.h \
...
echo "src/gen: regenerated mark.h splash.c splash.h font16.h horizon.h tdfx.h banners.c" \
